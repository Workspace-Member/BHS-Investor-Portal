...
//   };
//   return (
//     <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-2 py-4 lg:px-8 md:px-8 lg:py-8 md:py-8 bg-gradient-to-br from-blue-50 to-indigo-100">
//       <motion.div
